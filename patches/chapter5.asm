...
;Then, search for the puppets called "Mystery Dollsˮ which are hidden in the ruins spread around the world.
...
widestring_038C76 `[TPL:E]He quietly started playing[N]the melody that Laura had[N]taught him.[END]`
;Quietly started playing the melody that Laura had taught.

widestring_038CDB `[TPL:E]He quietly started playing[N]the melody that Laura had[N]taught him.[FIN][::][TPL:E]But [LU1:B9]happened.[END]`
...
widestring_08F157 `[SFX:10][TPL:D]A voice echoed inside of[N]Tim's head.[FIN][TPL:4][BOR:4][TPL:E]O Tim. I have long been[N]laying in wait for this[N]time to come.[FIN]My name is Friedan. I am[N]something that exists[N]beyond time.[FIN][TPL:F]From here on, I intend to[N]assist on your journey.[N]When the time for me has[N]come, then by nature, you[WAI][N]will know it…[FIN][CLD][SFX:10][TPL:D]Tim's consciousness[N]gradually receded…[END]`
