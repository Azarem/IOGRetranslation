...
widestring_04D8D2 `[TPL:0][TPL:C][NAM:0]: …What's this?[FIN][TPL:23][TPL:E]Flute: Did you not hear[N]something from Grandpa[N]Bill?[FIN][TPL:0][TPL:E][NAM:0]: My grandpa? He was[N]an architect, right..?[FIN][TPL:23][TPL:E]Flute: Your grandpa, he[N]knew the secret of those[N]stones.[FIN][TPL:0][TPL:E][NAM:0]: The stones'[N]secret…?[FIN][TPL:23][TPL:F]Flute: The situations that[N]you're going to face from[N]now on are going on be[N]a little bit scary.[FIN][TPL:0][TPL:F][NAM:0]: Scary situations…?[FIN][TPL:23][TPL:F]Flute: Pick up the stones[N]left by the enemies.[FIN]The power of the comet is[N]contained in them.[FIN]That power will definitely[N]be your ally…[FIN]Then, search for the[N]puppets called "Mystery[N]Dollsˮ which are hidden in[N]the ruins spread around[WAI][N]the world.[FIN]The demons will become[N]more powerful as the comet[N]becomes closer…[FIN][NAM:0]… There's no time…[N]So hurry… First,[N]to the Inca's ruins…[FIN][CLD][TPL:F]Sadly, the flute's voice[N]gradually become quiet[N]until it could no longer[N]be heard.[END]`
