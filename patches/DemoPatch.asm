...
;demo_string `[TPL:1C][DLG:5,4][SIZ:B,1][DLY:0]Thank you for playing![DLG:3,A][SIZ:D,6]Tools and ASM by: Kassiven[N] Translation By: L Thammy[N]  Thanks: ViewifulSlayer[N]--------------------------[N] For latest updates, |[ESC:CC,CD,CE,CF][N]  join our Discord!  |[ESC:EC,ED,EE,EF][FIN]      This ends the[N]  retranslation content.[N] You may continue playing[N] but dialog elements will[N]      be incorrect.[FIN][CLD][TPL:1C][DLG:5,4][SIZ:B,1][CLD]`
...
;widestring_04923D `[TPL:19][BOR:7][TPL:E]     Stream Starting[N]           [ESC:CC,CD,CE,CF][N]           [ESC:EC,ED,EE,EF][END]`
