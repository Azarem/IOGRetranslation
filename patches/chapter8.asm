...
widestring_09CE01 `[TPL:2][TPL:9][NAM:2]: [NAM:0]. Remember the[N]elder's words well.[FIN][TPL:B]"In the cliff of Larai in[N]the ruin's underground,[N]offer the Incan god to the[N]place where the god's[WAI][N]breath cannot reach.[FIN]The wind in the valley[N]shall guide that person to[N]the origin of the gold[N]shipˮ is the words,[FIN]Have you diligently[N]memorized it?[END]`
