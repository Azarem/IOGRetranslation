...
?INCLUDE 'sE6_gaia'
-------------------------------------
widestring_08E428 `[PRT:@widestring_08DE96]Will's [LU1:C2]is the [N][LU2:31]Dash. Use [LU1:D6]to [N]climb hills and jump. [FIN]There are [LU1:B6]hills at[N]the [LU1:16]Wall of China.[N]Try everything.[FIN][RET]`
