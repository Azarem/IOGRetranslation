...
widestring_049F71 `[DLG:3,13][SIZ:D,2][TPL:1]Karen: Are these your[N]parents in this picture?[FIN][TPL:0]Tim: That's right. Dad[N]went on an expedition...[PAL:0][END]`
;Karen: Are these your parents in this picture?
;Tim: That's right. Dad went on an expedition...

widestring_049FBC `[TPL:A][TPL:1]Karen: I know. it was[N]Allman's expedition team,[N]right? There was an[WAI][N]accident, huh.[FIN][TPL:0]Tim: He's definitely[N]coming home someday.[FIN][TPL:1]Karen: Are you angry?[N]...That's wrong, huh.[FIN]I must have made you sad..[N]I'm sorry...[PAL:0][END]`
...
widestring_049A3F `[TPL:A][TPL:3]Laura: Ohohohoho. Stop[N]it, dear! Bringing up[N]that kind of thing now...[FIN]That's right! Tim, you[N]shouldn't be shocked.[FIN]There was a girl here[N]singing with us a while[N]ago, right...?[PAL:0][END]`
...
widestring_04A0D7 `[TPL:A][TPL:1]Karen: I think you've[N]got the wrong person.[N]I'm a flower girl[WAI][N]called Popongo.[FIN][PAL:0]Soldier: Your Highness![N]Do you think I can be[N]tricked with that kind[WAI][N]of red-faced lie...?[FIN]Ultimately, this is the[N]king's order. Even if it's[N]only with brute force,[WAI][N]we're bringing you home![END]`
...
widestring_049B18 `[TPL:A][TPL:3]Laura: If we're talking[N]about Edward Castle, it[N]has a giant aqueduct[WAI][N]underground.[FIN][TPL:4]Bill: I was the person[N]who built that that[N]labyrinthine aqueduct,[WAI][N]Tim.[FIN][TPL:0]Tim: Wha...![N]Really?[END]`
...
widestring_0495C9 `[PAU:1E][TPL:A][TPL:4]Bill: It was because I[N]was an architect long[N]ago.[PAL:0][END]`
;Bill: It was because I was an architect long ago.

widestring_0495EB `[TPL:B][TPL:4]There is a jail in that[N]castle's underground.[FIN]So that it would not be[N]simple for prisoners to[N]escape, it turned into a [N]complex structure.[FIN]However, the complex state[N]of mind of the people that[N]are sent to the jail I [N]created every day...[PAL:0][END]`
...
widestring_049685 `[TPL:A][TPL:4]Bill: Hey Tim. Don't you[N]think Grandma Laura's[N]only been cooking weird[WAI][N]things lately?[FIN]Last night was miso rice.[N]Before that, sashimi[N]curry. I can't stand[WAI][N]eating like this...[FIN]They say that when people[N]have grown old and can't[N]help but have questions[WAI][N]about their own lives,[N]they've started to go[N]senile, but...[FIN]Somehow your grandma[N]probably cannot bear the[N]troubles we can't[WAI][N]speak of...[PAL:0][END]`
...
widestring_04A4CC `[DLG:3,B][SIZ:D,3][TPL:0]Tim: Ultimately, dinner[N]was meat pies topped with[N]lots of whipped cream...[FIN]I only ate one slice, but[N]Grandpa Bill endured and[N]even ate three slices.[FIN]Then, that night, I had a[N]dream. A dream of going[N]on a trip around the[WAI][N]world with Karen..[PAL:0][END]`
...
widestring_049D94 `[TPL:A][TPL:3]Laura: Go, and be careful.[PAL:0][END]`
;Laura: Go, and be careful.

widestring_04977F `[TPL:A][TPL:4]Bill: Crystal ring...[N]Uhh, I don't think I've[N]even heard of that.[FIN]There wasn't anything[N]like that in the luggage[N]your dad, Allman, left[WAI][N]behind, either...[FIN]Anyhow, will you try to[N]go to Edward Castle? You[N]may be able to meet the[WAI][N]princess from yesterday.[N]Bwahahaha.[PAL:0][END]`
