...
widestring_04B210 `[TPL:A][TPL:4]Rob: Oy, Tim, don't hang[N]around there. Go sit next[N]to Eric.[PAL:0][END]`
;Rob: Oy, Tim, don't hang around there. Go sit next to Eric.

widestring_04B612 `[TPL:A][TPL:5]Morris: I have no interest[N]in girls. Reading books[N]is more fun.[PAL:0][END]`
;Morris: I have no interest in girls. Reading books is more fun.

widestring_04BB59 `[TPL:A][TPL:3]Eric: Guh. And I had been[N]thinking that maybe[N]everyone would be[WAI][N]surprised...[PAL:0][END]`
;Eric: Guh. And I had been thinking that maybe everyone would be surprised...

widestring_04B652 `[TPL:A][TPL:5]Morris: Alright, since[N]everyone's here, what[N]are we doing today?[FIN][TPL:3]Eric: I think I want[N]to see Tim's mysterious[N]powers.[FIN]Look, he showed it to us[N]the other day, didn't he?[N]The guy can move things[WAI][N]without using his hands.[FIN][TPL:4]Rob: If I'm rememberin',[N]I think he moved tha stone[N]statue in this cavern's[WAI][N]nook.[FIN]Tim.[N]Show us one more time.[PAL:0][END]`
...
widestring_04BB89 `[TPL:A][TPL:3]Eric: Recently, you moved[N]the stone statue without[N]being near it, right?[PAL:0][END]`
;Eric: Recently, you moved the stone statue without being near it, right?

widestring_04B23F `[TPL:A][TPL:4]Rob: I think ya spun yer[N]flute like a baton and[N]pulled it towards ya.[PAL:0][END]`
...
widestring_04B2F0 `[TPL:A][TPL:4]Rob: Come on. Find tha[N]one that ya think is tha[N]ace o' diamonds.[PAL:0][END]`
;Rob: Come on. Find tha one that ya think is tha ace o' diamonds.

widestring_04BBB6 `[TPL:A][TPL:3]Eric: I think it would be[N]nice. If I could also use[N]a power like that...[PAL:0][END]`
;Eric: I think it would be nice. If I could also use a power like that...

widestring_04B77C `[TPL:A][TPL:5]Morris: No matter how[N]many times you see it,[N]it's still cool, isn't[WAI][N]it...?[FIN]However, I wonder why[N]things like the desk[N]don't move, and only the[WAI][N]stone statue moves...[PAL:0][END]`
...
widestring_04B7DE `[TPL:A][TPL:5]Morris: You call it[N]"extrasensory perception",[N]huh?[FIN]The word means a sense[N]that goes beyond the[N]human senses...[FIN]What we call the human[N]senses are the sense of[N]sight,[FIN]the sense of hearing,[FIN]the sense of taste,[FIN]the sense of smell,[FIN]and the sense of touch;[N]it's what we call these[N]five..[FIN]I'm not sure, but I'm[N]thinking that what you[N]call extrasensory[WAI][N]perception is a sixth[N]sense.[PAL:0][END]`
...
widestring_04B344 `[TPL:A][TPL:4]Rob: I don't understand[N]tha things that Morris[N]tha scholar says all that[WAI][N]well.[PAL:0][END]`
;Rob: I don't understand tha things that Morris tha scholar says all that well.

widestring_04B386 `[TPL:A][TPL:4]Rob: Morris. Take out tha[N]cards; we'll have one[N]more match next.[PAL:0][END]`
