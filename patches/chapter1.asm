...
------------------------
widestring_0484B7 `[TPL:16][TPL:D]Hey, Tim… You shouldn't[N]be coming up here…[FIN][TPL:F]I think you have a[N]habit of jumping down[N]from various places,[N]though. I can't help[WAI][N]but worry. Aww.[END]`
...
widestring_08D20F `[CLD][TPL:16][TPL:F]Hmm… These are truly good[N]jewels, aren't they?[N]Please, it is important[N]to take care of them.[FIN]With this, I think the[N]number of jewels should[N]have become [BCD:2,AB0][N]altogether.[FIN]`
...
------------------------
widestring_0488FB `[TPL:16][TPL:E]You know, an astronomer[N]who is an acquaintance of[N]mine said something odd.[FIN]Something like,[N]"a star is approaching[N]our Earthˮ.[END]`
;You know, an astronomer who is an acquaintance of mine said something strange. Something like, "a star is approaching our Earthˮ.
...
?INCLUDE 'sc01_girl2'
------------------------
widestring_04816B `[TPL:16][TPL:F]But it's mysterious,[N]huh. I wonder if this is[N]the game called "the[N]Dharma doll fell downˮ…[END]`
;But it's mysterious, huh. I wonder if this is the game called "the Dharma doll fell downˮ…
...
------------------------
widestring_0487F5 `[TPL:16][TPL:E]When I see your hair[N]fluttering in the sea[N]breeze, I get jealous.[FIN]Mine is under this scarf…[END]`
;When I see your hair fluttering in the sea breeze, I get jealous. 
;Mine is under this scarf…

widestring_0487BF `[TPL:16][BOR:2][DLG:10,8][SIZ:3,1]Eeek…![FIN][CLD][::][TPL:16][TPL:D]What are you doing…!?[N]This kid…! Good grief…[END]`
...
------------------------
widestring_049110 `[TPL:16][TPL:9]Morris's mother: It's not[N]a joke…! That man…![FIN][TPL:B]Because of my son, Morris,[N]I'm tolerating it. But if[N]not for that, I'd have[N]divorced him long ago…![END]`
