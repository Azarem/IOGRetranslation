...
widestring_08D20F `[CLD][DEF]Hmm... These are truly[N]good jewels, aren't they?[N]Please, it is important[N]to take care of them.[FIN]With this, I think the[N]number of jewels should[N]have become [BCD:2,AB0][N]altogether.[FIN]`
...
widestring_08D267 `[CLD][DEF]I will give you the[N]commodity only when the[N]collected jewels reach[N]the number on the list.[END]`
...
widestring_04BD5F `[TPL:E][TPL:0]Here is my close friend[N]Rob's house. He lives here[N]with his frail mother.[PAL:0][END]`
;Here is my close friend Rob's house. He lives here with his frail mother.

widestring_04BD9B `[TPL:F][TPL:0]My friend Eric lives here.[FIN]This house is the biggest[N]in South Cape. I feel[N]jealous of people born to[N]families with money...[PAL:0][END]`
...
------------------------
widestring_0487F5 `[TPL:E]When I see your hair[N]fluttering in the sea[N]breeze, I get jealous.[FIN]Mine is under this[N]scarf...[END]`
;When I see your hair fluttering in the sea breeze, I get jealous. 
;Mine is under this scarf...

widestring_0487BF `[DLG:10,8][BOR:2][SIZ:4,1]Eeek...![FIN][CLD][::][TPL:D]What are you doing...!?[N]This kid...! Good grief...[END]`
...
------------------------
widestring_048A48 `[TPL:E][TPL:0]Just as I opened the door[N]to Morris' house, a pot[N]came flying out...![END]`
...
?INCLUDE 'sc07_chef'
------------------------
widestring_0491ED `[TPL:B]Well, that's a good[N]smell. There's no stove[N]in my home, so I cook[N]in this pot.[END]`
