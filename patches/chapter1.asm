...
?INCLUDE 'sc08_lance'
----------------------
widestring_048D3A `[TPL:4][TPL:A]Rob: Alright, to tha[N]coastal cave today[N]again, huh...?[END]`
...
------------------------
widestring_04923D `[TPL:16][TPL:F]You seem like you've[N]got pretty fast feet, huh.[N]You run when you mash the[N]direction button twice.[END]`
;You seem like you've got pretty fast feet, huh. You run when you mash the direction button twice.

------------------------
?INCLUDE 'jeweler_gem'
------------------------
widestring_08D094 `[TPL:16][TPL:F]I am Gem, a jewel[N]merchant that travels[N]about the seven seas.[FIN]`
...
widestring_08D139 `[CLD][TPL:16][TPL:F]Is that so. Anyway,[N]nice to meet you.[FIN]By the way, if you lift[N]up a jewel, it will fly[N]to my location, you know.[FIN]So something seems to be[N]hidden. I am a master of[N]disguise, after all. But[N]in other towns, maybe[WAI][N]you won't recognize me.[END]`
...
widestring_08D20F `[CLD][TPL:16][TPL:F]Hmm... These are truly[N]good jewels, aren't they?[N]Please, it is important[N]to take care of them.[FIN]With this, I think the[N]number of jewels should[N]have become [BCD:2,AB0][N]altogether.[FIN]`
...
?INCLUDE 'sc01_guard'
------------------------
widestring_0485B6 `[TPL:16][TPL:F]Hey, hey. Monsters have[N]been seen outside of[N]town recently.[FIN]Did the priest in the[N]church not warn you? You[N]shouldn't thoughtlessly[N]go outside the town.[END]`
...
------------------------
widestring_0488FB `[TPL:16][TPL:E]You know, an astronomer[N]who is an acquaintance of[N]mine said something odd.[FIN]Something like,[N]"a star is approaching[N]our Earth".[END]`
...
widestring_04BD9B `[TPL:0][TPL:F]My friend Eric lives here.[FIN]This house is the biggest[N]in South Cape. I feel[N]jealous of people born to[N]families with money...[END]`
...
?INCLUDE 'sc01_girl2'
------------------------
widestring_04816B `[TPL:16][TPL:F]But it's mysterious,[N]huh. I wonder if this is[N]the game called "the[N]Dharma doll fell down"...[END]`
;But it's mysterious, huh. I wonder if this is the game called "the Dharma doll fell down"...

------------------------
?INCLUDE 'sc01_girl1'
------------------------
widestring_0480FF `[TPL:16][DLG:5,8][SIZ:9,1][DLY:2]The Dharma doll...[END]`
;The Dharma doll...

widestring_048112 `[TPL:16][DLG:7,8][SIZ:6,1][DLY:1]..fell down![END]`
;...fell down!
...
------------------------
widestring_0487F5 `[TPL:16][TPL:E]When I see your hair[N]fluttering in the sea[N]breeze, I get jealous.[FIN]Mine is under this[N]scarf...[END]`
;When I see your hair fluttering in the sea breeze, I get jealous. 
;Mine is under this scarf...

widestring_0487BF `[TPL:16][BOR:2][DLG:10,8][SIZ:4,1]Eeek...![FIN][CLD][::][TPL:16][TPL:D]What are you doing...!?[N]This kid...! Good grief...[END]`
...
------------------------
widestring_04840F `[TPL:16][TPL:E]Even if I change places[N]a bit, it ain't easy to[N]fish out...[END]`
;Even if I change places a bit, it ain't easy to fish out...

widestring_0483F6 `[TPL:16][TPL:E]Kuh... It isn't easy[N]to fish out, even a[N]little...[END]`
;Kuh... It isn't easy to fish out, even a little...

widestring_048436 `[TPL:16][TPL:D]I ended up fishing[N]out this weird pot.[END]`
...
------------------------
widestring_04907B `[TPL:16][TPL:F]Eric's mother: Don't[N]worry, my back isn't on[N]fire, haha. This what you[N]call "moxibustion".[FIN]With a big house, even[N]when you're just cleaning,[N]you can't help hurting[N]your shoulder...[END]`
...
------------------------
widestring_049193 `[TPL:16][TPL:B]Morris's father: Hmph.[N]What's wrong with[N]drinking alcohol with[N]the money I earned!?[END]`
;Morris's father: Hmph. What's wrong with drinking alcohol with the money I earned!?

------------------------
?INCLUDE 'sc05_seths_mother'
------------------------
widestring_049110 `[TPL:16][TPL:B]Morris's mother: It's[N]not a joke...! That[N]man...![FIN]Because of my son, Morris,[N]I'm tolerating it. But if[N]not for that, I'd have[N]divorced him long ago...![END]`
...
?INCLUDE 'sc06_lola'
------------------------
widestring_0499F1 `[TPL:3][TPL:F]Laura: Oh, Tim.[N]Welcome home.[N]There's time until dinner,[N]so go play outside.[END]`
