...
--------------------------------
widestring_04C115 `[TPL:B]Soldier: This is King[N]Edward's castle. If you[N]came to have an audience[N]with the king, state your[WAI][N]name.[FIN][CLD][BOR:3][TPL:9][TPL:0]Tim showed King Edward's[N]letter to the doormen.[FIN][BOR:0][TPL:A][PAL:0]Soldier: You're a guest[N]of the king? Excuse our[N]discourtesy. Please enter.[END]`
...
--------------------------------
widestring_04C229 `[TPL:B]This is King Edward's[N]castle. We sincerely hope[N]you avoid blunders, as the[N]king is a rather strict[WAI][N]gentleman.[END]`
;This is King Edward's castle. We sincerely hope you avoid blunders, as the king is a rather strict gentleman.

widestring_04C067 `[TPL:B]This is King Edward's[N]castle. If you're having[N]an audience with the king,[N]ascend to the upper floor.[END]`
...
--------------------------------
widestring_04C34B `[TPL:E]King Edward is having[N]breakfast. Please come[N]back shortly.[END]`
;King Edward is having breakfast. Please come back shortly.

widestring_04C271 `[TPL:F]Shh... Don't raise your[N]voice. You're going to[N]give away that I'm[N]skipping work....[FIN]`
widestring_04C2C2 `[TPL:F]Shh... Don't raise your[N]voice. You're going to[N]give away that I'm[N]skipping work....[END]`
...
--------------------------------
widestring_04D1BE `[TPL:B]Soldier: Ahead of here is[N]the underground jail.[N]Ordinary people can't[N]trespass there.[END]`
;Soldier: Ahead of here is the underground jail. Ordinary people can't trespass there.

--------------------------------
?INCLUDE 'ec0A_stair_maid'
--------------------------------
widestring_04C818 `[TPL:A]You're Tim, huh. Weren't[N]you summoned to King[N]Edward?[FIN]Somehow the king is making[N]me uncomfortable. Be[N]careful.[END]`
...
--------------------------------
widestring_04C8CA `[TPL:9][TPL:7]I.. I..[N]the thing with you is...[PAL:0][END]`
;I-I, the thing with you is...

--------------------------------
?INCLUDE 'ec0A_caring_maid'
--------------------------------
widestring_04C8FB `[TPL:B]Jeez,[WAI][N]this guy is so darn shy...[FIN]But, you know, having[N]someone somewhere in the[N]world that's always[N]thinking of you...[END]`
...
--------------------------------
widestring_04CA0D `[TPL:B]Soldier: This is Her[N]Majesty the princess'[N]room, so strangers cannot[N]pass.[END]`
;Soldier: This is Her Majesty the princess' room, so strangers cannot pass.

--------------------------------
?INCLUDE 'ec0A_kara'
--------------------------------
widestring_04CC6E `[TPL:9][TPL:1]Karen: Who's that?[PAL:0][PAU:5A][CLD]`
;Karen: Who's that?

widestring_04CC84 `[TPL:9][TPL:1]Karen: Do I have a guest?[PAL:0][END]`
;Karen: Do I have a guest?

widestring_04CA41 `[TPL:A]Soldier: It's somewhat[N]dirtied commoner boy.[FIN][TPL:0]Tim: It's me, Karen![FIN][TPL:1]Karen: Ah...[N]That voice is...[FIN]Please let him pass. Or[N]else I'll expose your old[N]nickname.[FIN][PAL:0][SFX:10]Soldier: Eek...![N]F-forgive me for that![N]Please, go ahead.[END]`
...
widestring_04CB20 `[TPL:9]Soldier: Your Majesty,[N]it's about time...[END]`
;Soldier: Your Majesty, it's about time...

widestring_04CDC0 `[PAU:28][TPL:B][TPL:1]Karen: Hey Tim. I'm very[N]anxious. Dad and Mom seem[N]like they're different[N]people now.[FIN]I'm begging you, help me.[N]Take me out of here[N]somehow! Please...[FIN][SFX:10][PAL:0]Soldier: Your Majesty...[FIN][::][TPL:1]Karen: Please. You're[N]definitely going to come[N]for me, right, Tim?[PAL:0][END]`
...
widestring_04CAF5 `[TPL:9]Alright, your business is[N]done. Go home! Go home![FIN]Haiyah![PAU:A][CLD]`
...
--------------------------------
widestring_04C7BF `[TPL:A]The king hired an assassin[N]recently. I wonder what in[N]the world he's thinking...[END]`
;The king hired an assassin recently. I wonder what in the world he's thinking...

widestring_04C379 `[DEF]Ahead of here is the[N]audience room. If you're[N]meeting with the king, you[N]may ascend these stairs.[END]`
;Ahead of here is the audience room. If you're meeting with the king, you may ascend these stairs.

--------------------------------
?INCLUDE 'ec0A_door_guard'
--------------------------------
widestring_04C5D9 `[TPL:E]Soldier: It's Tim, right?[FIN]We've been waiting for[N]you. Alright, go to King[N]Edward.[END]`
...
--------------------------------
widestring_04C66F `[TPL:B]Soldier: If you're here[N]for an audience, don't[N]loiter. Address the[N]king instead.[END]`
;Soldier: If you're here for an audience, don't loiter. Address the king instead.

--------------------------------
?INCLUDE 'ec0A_edwina'
--------------------------------
widestring_04C58D `[DEF][TPL:3]Queen Edward: The king is[N]the one who sent you the[N]letter. Please speak to[N]the person over there.[PAL:0][END]`
;Queen Edward: The king is the one who sent you the letter. Please speak to the person over there.

--------------------------------
?INCLUDE 'ec0A_edward'
--------------------------------
widestring_04C40E `[TPL:F][TPL:4]King Edward: YOU'RE Tim?[N]You're dressed rather[N]drab, I'd think.[FIN]Well, let's get on with[N]it. Did you bring the[N]Crystal Ring?[WAI][PAL:0][N] Yes[N] No`
...
widestring_04C556 `[PAU:1E][TPL:9][PAL:0]Soldier: Yes, sir![N]Right away![PAU:28][CLD]`
;Soldier: Yes, sir! Right away!

widestring_04C76A `[TPL:D][TPL:0]Tim: Old lady![N]Help me...![FIN][TPL:3]Queen Edward: Did you say[N]"OLD LADY"...?![PAL:0][END]`
