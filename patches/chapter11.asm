...
------------------------------------
widestring_038DDA `[TPL:0][TPL:D]We bit into the bone-in[N]meat.[FIN][TPL:E]We felt that it was the[N]tastiest thing we had ever[N]eaten.[END]`

widestring_059CEB `[DLG:9,7][SIZ:7,1]2nd Day Adrift[END]`

widestring_059EE3 `[TPL:1][TPL:B][NAM:1]: It's beautiful…[N]Even though I'm watching[N]it all day, I don't think[N]I'm getting tired of it…[END]`
...
widestring_05A03C `[TPL:1][TPL:A][NAM:1]: Somehow I have a[N]hunch… That rescue might[N]be coming…[FIN]Oh…?[END]`

widestring_05A074 `[TPL:1][TPL:A][NAM:1]: It looks like[N]something is drifting[N]this way…![END]`
...
widestring_059D07 `[DLG:9,7][SIZ:7,1]7th Day Adrift[END]`

widestring_05A291 `[PAU:1E][TPL:0][TPL:A][NAM:0]: First week adrift.[N]We came upon a school of[N]fish for a second time.[FIN]I'm already at the limit[N]of my strength.[FIN]I thought that if I didn't[N]eat now, I'd die…[END]`

widestring_05A319 `[TPL:1][TPL:8][NAM:1]: …[END]`

widestring_05A332 `[TPL:1][TPL:8][DLY:0][NAM:1]: …[FIN][TPL:A][NAM:0]… I'm sorry for[N]speaking like that[N]yesterday…[FIN][TPL:B]I'll try to eat a fish[N]too. Because if I die,[N]there's nothing more that[N]I can do, right?[FIN]It's only in comfortable[N]times where you're able to[N]avoid eating foods that[N]you dislike, huh…[FIN][TPL:0][TPL:B][NAM:0]: Allllright. Well,[N]I'll get a fish for you.[N]The tastiest one.[END]`

widestring_05A405 `[TPL:0][TPL:9][DLY:0][NAM:0]: [NAM:1] ate the[N]delicious-looking fish.[FIN][TPL:A]It seemed like I had come[N]to take a tiny bit of[N]concern about [NAM:1]…[END]`
