...
widestring_04A81F `[TPL:0][TPL:C]Tim: What happened!?[FIN][TPL:1][TPL:C]Karen: Look at this wall![FIN][TPL:D]This emblem, the mark of a[N]leopard with black fur…[FIN]That means Black Panther[N]came here![FIN][TPL:0][TPL:D]Tim: "Black Pantherˮ…?[FIN][TPL:1][TPL:D]Karen: The assassin that[N]my mother hired recently![FIN]He's a tenacious, morbid,[N]sinister man.[FIN][TPL:E]If he has someone in his[N]sights once, it's already[N]over… [FIN]He's a man that with no[N]concern whatsoever about[N]things like human life![FIN][TPL:0][TPL:E]Tim: Then,[WAI][N]Grandpa and Grandma…[END]`
;Tim: What happened!?
