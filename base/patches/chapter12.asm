...
widestring_05AEA3 `[TPL:16][TPL:D]Man: This is the southern[N]outskirts of Oakland.[FIN][TPL:F]If you head northward for[N]about half a day, there's[N]the Capital of Flowers,[N]Freejia.[FIN]I think if you're[N]searching for your friends[N]you were split from…[FIN]You should try doing it in[N]a big city.[END]`

widestring_05AF2F `[TPL:1][TPL:A][NAM:1]: Anyhow, let's try[N]going to that city called[N]Freejia.[FIN][TPL:B]I'm going to go give my[N]thanks to the dog. If[N]you're ready you can come[N]talk to me, alright?[END]`
...
?INCLUDE 'dc30_kara'
------------------------------------
widestring_05AADD `[TPL:1][TPL:E][NAM:1]: He said this dog's[N]name is Turbo. They seem[N]like a smart dog, huh.[FIN]Alright, let's go. We'll[N]definitely find [NAM:2],[N][NAM:4] and [NAM:3].[FIN][CLD][TPL:E]Like this, the two head to[N]the Capital of Flowers,[N]Freejia.[END]`
