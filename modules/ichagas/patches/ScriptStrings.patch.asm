...
?IF 'FreejiaShortcut'
  ...
  dialogstring_05D48E! `[TPL:5][TPL:E][NAM:A]: Eu conheço uma[N]passagem secreta que leva[N]até Freesia.[FIN]Quer pegar esse atalho?[N][PAL:0] Ficar[N] Ir à Freesia[PAL:4]`
?ELSE
  dialogstring_05D48E! `[TPL:5][TPL:E][NAM:A]: Eu conheço uma[N]passagem secreta que leva[N]até Freesia.[FIN]Quer pegar esse atalho?[N][PAL:0] Ficar[N] Ir à Freesia[PAL:4]`
?ENDIF
...
------------------------------------
dialogstring_0BF3F4! `[DLG:6,A][SIZ:A,4]Iniciar Jornada[N]Apagar Diário[N]Copiar Diário[N]Opções`
dialogstring_0BF437! `[DLG:2,8][SIZ:E,7]Em qual Diário?[N][::] Diário 1 - [ADR:&diary_entry_table,D74][N][N] Diário 2 - [ADR:&diary_entry_table,D76][N][N] Diário 3 - [ADR:&diary_entry_table,D78]`
dialogstring_0BF476! `[DLG:2,8][SIZ:E,7]Qual Diário?[N][JMP:&dialogstring_0BF437+M]`
dialogstring_0BF48C! `[DLG:2,8][SIZ:E,7]Copiar qual Diário?[N][JMP:&dialogstring_0BF437+M]`
dialogstring_0BF4A7! `[DLG:2,8][SIZ:E,7]Apagar qual Diário?[N][JMP:&dialogstring_0BF437+M]`
dialogstring_0BF4C3! `[DLG:2,C][::][SKP:2]PV[SKP:1][BCD:2,D9A][SKP:2]ATQ[SKP:1][BCD:2,D9C][SKP:2]DEF[SKP:1][BCD:2,D9E]`
dialogstring_0BF4EA! `[DLG:2,10][::][SKP:2]PV[SKP:1][BCD:2,D9A][SKP:2]ATQ[SKP:1][BCD:2,D9C][SKP:2]DEF[SKP:1][BCD:2,D9E]`
dialogstring_0BF511! `[DLG:2,14][::][SKP:2]PV[SKP:1][BCD:2,D9A][SKP:2]ATQ[SKP:1][BCD:2,D9C][SKP:2]DEF[SKP:1][BCD:2,D9E]`
dialogstring_0BF538! `[DLG:6,8][SIZ:A,8]Opções[N]Salvar Mudanças[N]Nomes[N]Esquema de Botões[N][SKP:5]   :Atacar/Falar[N][SKP:5]   :Item/Cancelar[N][SKP:5]   :Inventário[N][SKP:5]   :Correr`
dialogstring_0BF5AD! `[DLG:6,8][SIZ:A,8]Configuração OK?[N]Iniciar Jornada[N]Nomes[N]Esquema de Botões[N][SKP:5]   :Atacar/Falar[N][SKP:5]   :Item/Cancelar[N][SKP:5]   :Inventário[N][SKP:5]   :Correr`
...
dialogstring_0BF66B! `Japoneses`
dialogstring_0BF672! `Americanos`
dialogstring_0BF679! `[DLG:4,15][SIZ:C,2][DLY:FF]O Diário não está vazio[N]Apagar e Selecionar[FIN][CLD]`
dialogstring_0BF6A4! `[DLG:4,A][ADR:&table_0BF6AD,D94]`
dialogstring_0BF6B3! `[DLG:4,8][SIZ:D,5][ADR:&table_0BF6D9,D94][N][N]Apagar Diário? [N] Não [N] Sim `
dialogstring_0BF6DF! `Diário 1: [ADR:&diary_entry_table,D74]`
dialogstring_0BF6EC! `Diário 2: [ADR:&diary_entry_table,D76]`
dialogstring_0BF6F9! `Diário 3: [ADR:&diary_entry_table,D78]`
dialogstring_0BF630! `[DLG:18,E][SFX:0][ADR:&table_0BF63B,D8E]`
